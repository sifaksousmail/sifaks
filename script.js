...
const translationEntries = [
  ...
  ['software.aboutText', 'EuuuhAI for French is an experimental language learning tool by Sifaks Ousmail. It explores how AI-assisted feedback, applied linguistics, and language education can support French pronunciation training for Chinese native speakers.', 'EuuuhAI for French est un outil expérimental d’apprentissage des langues par Sifaks Ousmail. Il explore comment le feedback assisté par l’IA, la linguistique appliquée et l’éducation aux langues peuvent soutenir l’entraînement à la prononciation française des apprenants sinophones.', '优法音 AI（EuuuhAI for French）是 Sifaks Ousmail 开发的实验性语言学习工具，定位为针对中文母语者的AI辅助法语发音训练工具。'],
  ...
  ['software.previewNote', 'This static preview reflects the EuuuhAI for French prototype direction, not a final public release.', 'Cet aperçu statique reflète l’orientation du prototype EuuuhAI for French, et non une version publique finale.', '该静态预览展示 EuuuhAI for French 原型方向，并非最终公开版本。'],
  ...
  ['software.researchText', 'The project connects to second language acquisition, French as a foreign language, Chinese native speakers, pronunciation learning, and AI-supported language education.', 'Le projet est relié à l’acquisition des langues secondes, au français langue étrangère, aux apprenants sinophones, à l’apprentissage de la prononciation et à l’éducation aux langues soutenue par l’IA.', '该项目连接第二语言习得、对外法语、中文母语者、发音学习和 AI 支持的语言教育。'],
  ...
  ['software.appLinkText', 'Open EuuuhAI for French at app.sifaks.com →', 'Ouvrir EuuuhAI for French sur app.sifaks.com →', '打开 app.sifaks.com 上的优法音 AI →'],
  ['software.appLinkAria', 'Open EuuuhAI for French app preview at app.sifaks.com', 'Ouvrir l’aperçu de l’application EuuuhAI for French sur app.sifaks.com', '打开 app.sifaks.com 上的优法音 AI（EuuuhAI for French）应用预览'],
